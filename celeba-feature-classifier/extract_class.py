...
if __name__ == "__main__":
    ...
    neg_attr = args.target_class
    os.makedirs(f"{dst_folder}/all{neg_attr}/data", exist_ok=True)
    ...
    for idx, img_row in attribute_label_df.iterrows():
        ...
        if img_neg_attr_label == 1:
            shutil.copy(f"{image_folder}/{img_id}", f"{dst_folder}/all{neg_attr}/data/{img_id}")
